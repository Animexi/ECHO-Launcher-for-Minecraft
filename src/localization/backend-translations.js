...
const backendTranslations = {
  ru: {
    ...
    stage_installing_forge: 'Установка Forge...',
    stage_installing_forge_progress: 'Установка Forge ({current}/{total} библиотек)',
    stage_installing_neoforge: 'Установка NeoForge...',
    stage_installing_neoforge_progress: 'Установка NeoForge ({current}/{total} библиотек)',
    stage_installing_quilt: 'Установка Quilt...',
    stage_installing_quilt_progress: 'Установка Quilt ({current}/{total} библиотек)',
  ...
  en: {
    ...
    stage_installing_forge: 'Installing Forge...',
    stage_installing_forge_progress: 'Installing Forge ({current}/{total} libraries)',
    stage_installing_neoforge: 'Installing NeoForge...',
    stage_installing_neoforge_progress: 'Installing NeoForge ({current}/{total} libraries)',
    stage_installing_quilt: 'Installing Quilt...',
    stage_installing_quilt_progress: 'Installing Quilt ({current}/{total} libraries)',
